...
export default function AchievementsPage() {
  ...
  // Aggregate stats across courses
  const totalCompletedLessons = currentUser.enrolledCourses.reduce((acc, c) => acc + c.completedLessons.length, 0);

  const BADGES = [
    { id: "first-steps", icon: "👶", name: "First Steps", desc: "Enroll in your first course", unlocked: currentUser.enrolledCourses.length > 0 },
    { id: "on-fire", icon: "🔥", name: "On Fire", desc: "Reach a 3 Day Streak", unlocked: currentUser.streak >= 3 },
    { id: "smarty", icon: "🧠", name: "Smarty Pants", desc: "Reach Level 5", unlocked: currentUser.level >= 5 },
    { id: "js-king", icon: "👑", name: "Lesson Legend", desc: "Complete 10 Lessons", unlocked: totalCompletedLessons >= 10 },
