...
export default function CertificatePage() {
  ...
  const completionPercentage = Math.round((completedModules.length / COURSE_MODULES.length) * 100) || 0;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center">
      <div className="text-center mb-12">
        ...
        <p className="text-zinc-400 text-lg">Generate and download your verified JSVerse Ultimate completion certificate.</p>
      </div>
      ...
      >
        ...
        <h1 className="text-5xl md:text-6xl font-serif font-bold text-white mb-6">JSVerse Ultimate</h1>
